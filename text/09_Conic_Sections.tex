...
\mtable[yshift=7\baselineskip]{Graphing the ellipse in \autoref{ex_conic4}.}{fig:conic4}{\begin{tikzpicture}[alt={Horizontal ellipse; endpoints marked at (--2,2) and (4,2), two interior foci near (-1.2,2) and (3.2,2), and center at (1,2).  The range of values is -2<x<4 and 0<y<4.}]
\begin{axis}[width=1.16\marginparwidth,tick label style={font=\scriptsize},
