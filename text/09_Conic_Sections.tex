...
\mtable[-1.2in]{Graphing the hyperbola $\frac{x^2}9-\frac{y^2}1 = 1$ along with its asymptotes, $y=\pm x/3$.}{fig:hyperbola_asy1}{\begin{tikzpicture}[alt={Blue hyperbola x²/9−y²=1 with red dashed asymptotes y=±x/3; axes roughly −5<x<5, −2<y<2.}]
\begin{axis}[width=1.16\marginparwidth,tick label style={font=\scriptsize},
