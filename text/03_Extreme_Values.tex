...
\mnote{\textbf{Note:} The terms \emph{local minimum}, \emph{local maximum}, and \emph{local extrema} are often used as synonyms for \emph{relative minimum}, \emph{relative maximum}, and \emph{relative extrema}.}
...
\mtable[yshift=20\baselineskip]{A table of extreme values and graph of $f(x)$ on $[-4,2]$ as in \autoref{ex_extval5}.}{fig:extval5}{%
\tagpdfsetup{table/header-rows={1}}
\begin{tabular}{rr}
 $x$ & $f(x)$ \\ \midrule
 $-4$ & 25 \\
