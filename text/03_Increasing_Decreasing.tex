...
\mtable{The four cases of\\\autoref{thm:first_der}}{fig:first_deriv_examples}{%
...
\mtable{A graph of $f(x)$ in \autoref{ex_incr2}, showing where $f$ is increasing and decreasing.}{fig:incr2}{\begin{tikzpicture}[alt={Blue f with vertical asymptote at x=0; decreases left and increases right. Red f′ zero near −2,2 and dives negative at x=0.}]
\begin{axis}[width=1.16\marginparwidth,tick label style={font=\scriptsize},
axis y line=middle,axis x line=middle,name=myplot,
