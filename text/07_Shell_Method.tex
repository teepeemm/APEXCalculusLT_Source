...
%
\mtable[-2\baselineskip]{Graphing a region in \autoref{ex_shell1}.}{fig:shell1}{\begin{tikzpicture}[alt={Blue curve y=1+1/x² on 0.5<x<3; pale blue region under curve; red vertical line at sample x; axes x, y.}]
