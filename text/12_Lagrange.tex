...
\mtable[yshift=13\baselineskip]{The circle in \autoref{ex_lagr_circle}.}{fig_lagr_on_circle}{\begin{tikzpicture}[alt={A circle of radius √80 centered at the origin.  A line through the origin and (1,2) intersects the circle at the points ±(4,8).},x=.05\marginparwidth,y=.05\marginparwidth]
