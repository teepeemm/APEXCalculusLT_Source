...
\mtable[-.5in]{A graph of the conical water tank in \autoref{ex_pump2}.}{fig:pump2}{\begin{tikzpicture}[alt={Upside-down cone apex y=-10, top radius 2 at y=0; blue slice at depth y, volume V(y)=π(y/5+2)² dy; axes x,y.},x=.1cm,y=.125cm,>=stealth]
\draw [->] (0,-2) -- (0,37) node [above] {\scriptsize $y$};
