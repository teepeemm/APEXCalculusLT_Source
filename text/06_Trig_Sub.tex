...
\mtable[-\baselineskip]{A reference triangle for \autoref{ex_trigsub2}}{fig:sec_tri}{\begin{tikzpicture}[alt={Right triangle: base 1/2, vertical leg √(x²-1/4), hypotenuse x; right angle at right, θ at left.}]
...
\end{align*}
%
\mtable{A reference triangle for \autoref{ex_trigsub4}}{fig:sin_tri}{\begin{tikzpicture}[alt={Right triangle: base √(4-x²), vertical leg x, hypotenuse 2; right angle at right, θ at left.}]
