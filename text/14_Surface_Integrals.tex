...
\begin{align*}
	...
	\intertext{Over \intertextmathbegin$\surfaceS_1$\intertextmathend, \intertextmathbegin$\vec F_2 = \vec F_2\bigl(\vec r_2(u,v)\bigr) =\bracket{0,0,0}$\intertextmathend. Therefore,}
...
\begin{align*}
	...
	\intertext{Over \intertextmathbegin$\surfaceS_2$\intertextmathend, \intertextmathbegin$\vec F_2 = \vec F_2\bigl(\vec r_2(u,v)\bigr) =\bracket{0,0,1-v^2}$\intertextmathend. Therefore,}
