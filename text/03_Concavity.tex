...
\mtable[2\baselineskip]{A graph of $f(x) = x^4$. Clearly $f$ is always concave up, despite the fact that $\fpp(x) = 0$ when $x=0$. It this example, the \emph{possible} point of inflection $(0,0)$ is not a point of inflection.}{fig:concavity5}{\begin{tikzpicture}[alt={Blue quartic f(x)=x⁴, symmetric U always concave up; axes x=(−1–1), y=(0–1).}]
\begin{axis}[width=1.16\marginparwidth,tick label style={font=\scriptsize},
axis y line=middle,axis x line=middle,name=myplot,
