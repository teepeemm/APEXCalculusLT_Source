...
\label{fig:nolimit3}\tagstructend
\end{minipage}
...
\end{tikzpicture}
	\\ (a) & (b) & (c)
\end{tabular}}
\caption{Secant lines of $f(x)$ at $x=1$ and $x=1+h$, for shrinking values of $h$ (i.e., $h\rightarrow 0$).}\label{fig:diff_quot_small_h}\tagstructend
