...
\[
\text{\parbox{\iflatexml75pt\else\widthof{input specific}\fi}{\centering input specific\\number \intertextmath{c}}}
\longrightarrow
\text{\fbox{\parbox{\iflatexml80pt\else\widthof{do something}\fi}{\centering do something\\to \intertextmath{f} and \intertextmath{c}}}}
\longrightarrow
\text{\parbox{\iflatexml80pt\else\widthof{number $\fp(c)$}\fi}{\centering return\\number \intertextmath{\fp(c)}}}
\]
...
\longrightarrow
\text{\fbox{\parbox{\iflatexml80pt\else\widthof{do something}\fi}{\centering do something\\to \intertextmath{f} and \intertextmath{x}}}}
\longrightarrow
\text{\parbox{\iflatexml85pt\else\widthof{function $\fp(x)$}\fi}{\centering return\\function \intertextmath{\fp(x)}}}
\]
