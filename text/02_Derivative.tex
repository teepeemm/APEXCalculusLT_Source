...
\[
\text{\parbox{\widthof{input specific}}{\centering input specific\\number \intertextmath{c}}}
\longrightarrow
\text{\fbox{\parbox{\widthof{do something}}{\centering do something\\to \intertextmath{f} and \intertextmath{c}}}}
\longrightarrow
\text{\parbox{\widthof{number $\fp(c)$}}{\centering return\\number \intertextmath{\fp(c)}}}
\]
...
\longrightarrow
\text{\fbox{\parbox{\widthof{do something}}{\centering do something\\to \intertextmath{f} and \intertextmath{x}}}}
\longrightarrow
\text{\parbox{\widthof{function $\fp(x)$}}{\centering return\\function \intertextmath{\fp(x)}}}
\]
