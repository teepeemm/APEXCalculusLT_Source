...
\mtable[-2in]{Graphically representing three definite integrals that cannot be evaluated using antiderivatives.}{fig:numerical1}{\begin{tikzpicture}[alt={Blue curve y = e^(–x² on 0 ≤ x ≤ 1, starting at (0, 1) then falling smoothly to about (1, 0.4); region beneath is shaded.}]
