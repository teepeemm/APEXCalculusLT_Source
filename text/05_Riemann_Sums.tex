...
\mtable[-1in]{Approximating $\ds\int_{-1}^5 x^3\dd x$ using the Left Hand Rule and 10 evenly spaced subintervals.}{fig:rie9}{\begin{tikzpicture}[alt={Blue curve y=x³ from x = -1 to 5; ten left-end red rectangles approximate area; axes x and y.}]
\begin{axis}[width=1.16\marginparwidth,%
