...
\mtable[1.5in]{Graphing $\vec r(t)$ and its tangent line in \autoref{ex_vvfderiv3}.}{fig:vvfderiv3}{\begin{tikzpicture}[alt={Plane curve r (t)=⟨t, t²–1⟩ (blue) with red tangent line l(t) = r(0)+t r′(0) touching at (0, 0).},>=stealth]
\begin{axis}[width=1.16\marginparwidth,tick label style={font=\scriptsize},
axis y line=middle,axis x line=middle,name=myplot,
