...
\label{fig:vvfderiv_intro}\tagstructend
\end{minipage}
...
\mtable[yshift=8\baselineskip]{Graphing some of the derivatives of $\vec u(t)$ in \autoref{ex_vvfderiv2}.}{fig:vvfderiv2b}{\begin{tikzpicture}[alt={Blue circle u (t) with three red derivative vectors u′(t) drawn at t = π/2, π, 3π/2, indicating velocity directions.},>=stealth]
\begin{axis}[width=1.16\marginparwidth,tick label style={font=\scriptsize},
axis y line=middle,axis x line=middle,name=myplot,
