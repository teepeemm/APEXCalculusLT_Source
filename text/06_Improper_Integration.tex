...
\mtable[yshift=10\baselineskip]{Plotting functions of the form $1/x\,^p$ in \autoref{ex_impint4}.}{fig:impint4}{\begin{tikzpicture}[alt={Three decreasing curves on log axes: red f(x)=1/x^p (gentlest), dashed 1/x, blue f(x)=1/x^q (steepest); p<1<q.}]
\begin{axis}[width=1.16\marginparwidth,tick label style={font=\scriptsize},
