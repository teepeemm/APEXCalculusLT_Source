...
\intertext{The right hand side is just a number, so we replace it with \intertextmath{d}:}
ax+by+cz &= d\label{eq:planes2}.\\
\intertext{As long as \intertextmath{c\neq 0}, we can solve for \intertextmath{z}:}
...
\mtable[yshift=13\baselineskip]{Illustrating the intersection of a line and a plane in \autoref{ex_planes5}.}{fig:planes5}{%
\myincludeasythree{
