...
\mtable{$R$ is the union of two nonoverlapping regions, $R_1$ and $R_2$.}{fig:double_region}{\begin{tikzpicture}[alt={A planar region labeled R is split into two by a line.  The left region is labeled R1; the right is labeled R2.},xscale=.85,yscale=.6]
...
\mtable[yshift=30\baselineskip]{Determining the region $R$ determined by the bounds of integration in \autoref{ex_double6}.}{fig:double6}{\begin{tikzpicture}[alt={Horizontal lines at y=0 and y=3.  A vertical line at x=3.  A diagonal line y=x.  The region under the diagonal but in the first quadrant is labeled R.}]
...
\mtable[yshift=10\baselineskip]{Showing the surface $f$ defined in \autoref{ex_double6} over its region $R$.}{fig:double6b}{%
\myincludeasythree{
3Droll=0.,
...
\mtable[yshift=10\baselineskip]{Finding the average value of $f$ in \autoref{ex_double8}.}{fig:double8}{%
\myincludeasythree{
3Droll=0,
3Dortho=0.004656145814806223,
3Dc2c=0.9017289280891418 0.24087461829185486 0.35897672176361084,
