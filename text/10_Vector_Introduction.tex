...
\end{example}
	...
	\mtable[yshift=18\baselineskip]{Graphing vectors in \autoref{ex_vect1}.}{fig:vect1}{%
...
\text{lb}.\]
We can then use either equality from \autoeqref{eq:vect8} to solve for $\phi$. We choose the first equality as using arccosine will return an angle in the 2\textsuperscript{nd} quadrant:
