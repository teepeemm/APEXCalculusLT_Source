...
\mtable{A graph of a function $f$ to introduce the Mean Value Theorem and differently sized rectangles giving upper and lower bounds on $\int_1^4 f(x)\dd x$; the last rectangle matches the area exactly.}{fig:ftc7b}%
