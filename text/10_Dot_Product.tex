...
% todo bugfix see https://github.com/latex3/tagging-project/issues/986
\tagstructbegin{tag=Sect}%
\noindent%
%\captionsetup{type=figure}%
\centering
\begin{tikzpicture}[alt={Vectors u and v with common tail and angle θ between them in three situations: (1) acute θ, u·v > 0; (2) right angle θ = π/2, u·v = 0; (3) obtuse θ, u·v < 0.},>=stealth,thick,scale=1.25]
	\begin{scope}
	...
	\end{scope}
\end{tikzpicture}
\captionof{figure}{\label{fig:dotpsign}Illustrating the relationship between the angle between vectors and the sign of their dot product.}%
\tagstructend
\end{minipage}
...
\intertext{Replace \intertextmathbegin\(\cos\theta\)\intertextmathend{} using \autoref{thm:dot_product}:}
...
\mtable{Illustrating the orthogonal projection.}{fig:dotpprojc}{\begin{tikzpicture}[alt={Vectors u, v with right-angle foot; z fills gap so u = proj_v u + z.},>=stealth]
