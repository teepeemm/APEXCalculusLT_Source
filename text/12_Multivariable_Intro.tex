...
\mfigure[scale=.6,alt={USGS topographic sheet: contour lines join points of equal elevation, giving a real‑world level‑curve map.}]{}{A topographical map displays elevation by drawing contour lines, along with the elevation is constant.\\ \tiny Sample taken from the public domain USGS Digital Raster Graphics, \texttt{http://topmaps.usgs.gove/drg/}.}{fig:topomap}{figures/raw/MT_ChromeMountain_topo_smallx}
