...
\iflatexml
\ExplSyntaxOn
% todo bug https://github.com/brucemiller/LaTeXML/issues/2714
\AtBeginDocument{
...
\ExplSyntaxOff
\usepackage{amssymb} % bug needed for mathbb
...
\newcommand{\printconcepts}{\noindent\closeenumerate\exercisesubsubsection{Terms and Concepts}}
\newcommand{\printproblems}{\noindent\closeenumerate\exercisesubsubsection{Problems}}
\newcommand{\printreview}{\noindent\closeenumerate\exercisesubsubsection{Review}}
...
\newcommand{\printexercises}[1]{%
 \writeToAnsFile{#1}% writeToAnsFile down below
...
\newcommand{\exercisesetinstructions}[2][In~Exercises]{%
 \iflatexml
 \setcounter{saveenumi}{\value{saveexercisenum}}%
 \else
