...
\begin{itemize}
\item {\bfseries\ttfamily artifact} (image is decorative only)
...
\item ``Formulas need alt text'' \textrightarrow\ option \texttt{math/alt/use}
\item Have someone else do it?
\end{itemize}
\end{frame*}
