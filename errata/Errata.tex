...
The following error exists in the July 2025 printed version of Apex LT Calculus I:
\begin{enumerate}
% Calc 2,3 have no errors, so we force a label for "0"
\addtocounter{enumi}{-1}\refstepcounter{enumi}
\label{2025-07II}\label{2025-07III}
\item Figures 6.2.7(a), 6.2.8(a), \& 6.3.7(c) should have radii labeled as functions of $y$, not $x$.
\label{2025-07I}
\end{enumerate}
...
The following errors exist in the in June 2023 printed version of Apex LT Calculus III:
\begin{enumerate}
% Calc 2 had no errors, so we force a label for "0" so that it appears in the table
\addtocounter{enumi}{-1}\refstepcounter{enumi}\label{2023-06II}
...
In addition to 1--\ref{2018-07}, the following errors exist in the July 13, 2018 printed version of Apex LT Calculus I:
\begin{enumerate}\setcounter{enumi}{\getrefnumber{2018-07}}
...
In addition to 1--\ref{2018-07}, the following errors exist in the July 13, 2018 printed version of Apex LT Calculus II:
\begin{enumerate}\setcounter{enumi}{\getrefnumber{2018-07}}
...
In addition to 1--\ref{2018-07}, the following errors exist in the July 13, 2018 printed version of Apex LT Calculus III:
\begin{enumerate}\setcounter{enumi}{\getrefnumber{2018-07}}
\item It turns out that the units newton and joule are not capitalized.
...
In the July 2017 and November 2017 printed versions of Apex LT Calculus, there are numerous instances of ``$\lim A+B$''.  The convention seems to be that this should be ``$\lim(A+B)$''.  We believe that all such instances have been corrected for subsequent versions of the text.\bigskip

The following errors exist in the November 2017 printed version of Apex LT Calculus III:
\begin{enumerate}
...
\label{2017-11IIIplus}
\end{enumerate}\vspace{1in}

The following errors exist in the July 2017 printed versions of Apex LT Calculus I:
\begin{enumerate}
...
The following errors exist in the July 2017 printed versions of Apex LT Calculus II:
\begin{enumerate}
...
In addition to the previous, the following errors exist in the July 2017 printed version of Apex LT Calculus III:
\begin{enumerate}
